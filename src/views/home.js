...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Remarkable Electric Crocodile</title>
        <meta property="og:title" content="Remarkable Electric Crocodile" />
      </Helmet>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav31 bodySmall">Documentation</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading">
              <span>RBI Master Directions for Commertial Banks</span>
              <br></br>
            </h1>
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Discover the powerful features of our RBI Guide Bot chat
                      interface
                    </span>
                    <span>
                      <span
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                SubHeading="Intuitive and easy-to-use chat interface for seamless interaction with the RBI Guide Bot"
              ></FeatureCard>
              <FeatureCard
                Heading="Backend Data Parsing"
                SubHeading="Efficient parsing of backend data to extract relevant information for context-based responses"
              ></FeatureCard>
              <FeatureCard
                Heading="Vector Search"
                SubHeading="Utilization of vector search algorithms to find contextually accurate responses"
              ></FeatureCard>
              <FeatureCard
                Heading="Comprehensive Documentation"
                SubHeading="Thorough documentation covering all aspects of the solution, including setup, usage, and troubleshooting"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            <div className="home-container29">
              ...
              <h2 className="home-text73 heading2">Common questions</h2>
              <span className="home-text74 bodyLarge">
                <span>
            ...
            <div className="home-container30">
              <Question1
                Answer="The purpose of the RBI Guide Bot is to provide a user-friendly chat interface for accessing information and guidance related to RBI (Reserve Bank of India) regulations and policies."
                Question="What is the purpose of the RBI Guide Bot?"
              ></Question1>
              <Question1
                Answer="The backend data parsing involves extracting relevant information from RBI documents and converting it into a structured format that can be easily searched and retrieved by the chat interface."
                Question="How does the backend data parsing work?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container31">
            ...
            <nav className="home-nav1 bodySmall home-nav1">
              ...
              <span className="home-nav32 bodySmall">Documentation</span>
